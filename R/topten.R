...
#'
#' This function develops a prediction algorithm baesd on the top 10 features
...
#' calculates a p-value indicating the significance of the associetation. The
...
#' @param b b a vector of coefficients obtained from the \code{topten} function
